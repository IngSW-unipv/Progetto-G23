...
/**
 * JPanel relativo ad un acquisto di uno store item dell'admin. Utilizzato nella
 * AdminStoreView.
 *
...
public class AdminStoreAcquistoPanel extends JPanel {
	...
	public AdminStoreAcquistoPanel(AcquistoStore a) {
		...
		String price_str = "Prezzo: " + String.format("%.2f", a.getItem().getPrezzo()) + " € x " + a.getQuantita()
				+ " = " + String.format("%.2f", a.getItem().getPrezzo() * a.getQuantita()) + " €";
