...
/**
 * JPanel relativo ad uno store item presente nel carrello. Utilizzato nella
 * CarrelloView.
 *
...
public class CartItemPanel extends JPanel {
	...
	public CartItemPanel(Merchandising m, int quantity) {
		...
		String price_str = "Prezzo: " + String.format("%.2f", m.getPrezzo()) + " € x " + quantity + " = "
				+ String.format("%.2f", m.getPrezzo() * quantity) + " €";
