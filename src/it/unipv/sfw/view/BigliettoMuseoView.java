...
public class BigliettoMuseoView extends AView {
	...
	public BigliettoMuseoView(Dimension dim) {
		...
		scudettobasso = new ImageIcon(
				scudettobasso.getImage().getScaledInstance(100, 100, java.awt.Image.SCALE_SMOOTH));
		...
		scudetto.setHorizontalAlignment(SwingConstants.CENTER);
	...
	/**
	 * Metodo che lancia un'eccezione se si verifica un errore nella data
	 * selezionata.
	 *
