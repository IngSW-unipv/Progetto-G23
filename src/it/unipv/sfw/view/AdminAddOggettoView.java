...
public class AdminAddOggettoView extends AView {
	...
	public AdminAddOggettoView() {
		...
		blue_label_up.setHorizontalAlignment(SwingConstants.CENTER);
	...
	/**
	 * Metodo che imposta lo stato dei sottotipi di Riconoscimento come
	 * selezionabili.
	 */
	...
	/**
	 * Metodo che rende selezionabile il sottotipo del tipo Cimelio quando esso
	 * viene selezionato.
	 */
	public void showCimelioSubType() {
		if (!iscSubTypeShown()) {
			...
			for (TipoCimelio element : sottoTipiCimelio) {
				selectObjectSubType.addItem(element.toString());
			}
	...
	/**
	 * Metodo che rende selezionabile il sottotipo del tipo Riconoscimento quando
	 * esso viene selezionato.
	 */
	public void showRiconoscimentoSubType() {
		if (!isrSubTypeShown()) {
			...
			for (TipoRiconoscimento element : sottoTipiRiconoscimento) {
				selectObjectSubType.addItem(element.toString());
			}
