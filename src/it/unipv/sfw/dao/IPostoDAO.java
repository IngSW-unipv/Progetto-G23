...
public interface IPostoDAO {
	...
	/**
	 * @return Un array che contiene tutti i posti occupati per la partita
	 *         selezionata.
	 * @param dataPartita
	 */
	...
	/**
	 * @param dataPartita Data identificativa di una partita di cui si vuole
	 *                    conoscere i posti occupati.
	 * @return Il numero di posti occupati.
	 */
	int selectCount(Calendar dataPartita);

	/**
	 * @param email Email identificativa del cliente di cui si vuole sapere il
	 *              numero di biglietti acquistati.
	 * @return Il numero di biglietti acquistati dal cliente identificato dalla mail
